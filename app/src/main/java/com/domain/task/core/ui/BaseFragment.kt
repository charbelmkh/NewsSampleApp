package com.domain.task.core.ui
...
abstract class BaseFragment : Fragment(), HasAndroidInjector {
    ...
    inline fun <reified T : ViewModel> injectViewModel(): T {
        return ViewModelProvider(requireActivity(), viewModelProvider)[T::class.java]
    }
    ...
    private fun <T> handleErrorWithMessage(result: Result<T>, retry: () -> Unit) {
        result.ex?.let {
            when (it) {
